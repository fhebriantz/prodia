...
import {
 linechart, speedometer,columntable,population,datatable, piechart,stackedbarchartvertical, stackedbarcharthorizontal, barchart,donnutChart, inprogress,done,todo, columnPenggunaan, dataPenggunaan, columnPenggunaanMap, dataPenggunaanMap
} from "../Const/dummy";
import TableWithoutHeader from '@/Components/Molecules/Penggunaan/TableWithoutHeader';
                            ...
                            <Row gutter={[8,8]}>
                                <Col xs={24} sm={24} md={24} lg={24} xl={24}>
                                    <Row gutter={[8,8]}>
                                        ...
                                        <Col xs={24} sm={24} md={24} lg={24} xl={8}>
                                            <Table pagination={false} dataSource={dataPenggunaan} size="small" scroll={{ y: 260 }}>
                                        ...
                                        <Col xs={24} sm={24} md={24} lg={24} xl={16}>
                                            <Table pagination={false} dataSource={null} size="small" scroll={{ y: 260 }}>
                                                <ColumnGroup title={<span style={{ fontSize: 12 }}>Kendala Penggunaan</span>}>
                                                    <Column title={<span style={{ fontSize: 11 }}>No</span>}  width={50} dataIndex="key" key="key" render={(text) => <p style={{ fontSize: 11 }}>{text}</p>}/>
